...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PAID", "FAILED", "CANCELED", name="paymentstatus"),
            nullable=False,
        ),
        sa.Column(
            "source", sa.Enum("MANUAL", "GATEWAY", name="paymentsource"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["confirmed_by_admin_id"], ["users.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_paymenttransactions_status"),
        "paymenttransactions",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_paymenttransactions_user_id"),
        "paymenttransactions",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_paymenttransactions_user_id"), table_name="paymenttransactions"
    )
    op.drop_index(
        op.f("ix_paymenttransactions_status"), table_name="paymenttransactions"
    )
