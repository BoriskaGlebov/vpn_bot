...
# TODO Нужно для переменных поменять, сделать их маленькими буквами с подчеркиваниями
# TODO Нужно список админов сдлеать set-ом чтобы не было дубликатов и был быстрее поиск и вообще далее, что б все методы работали не сосписком админов тут, а из базы пусть берет админов
